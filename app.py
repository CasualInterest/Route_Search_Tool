...
# Whitelist of allowable Fleet options for the dropdown
...
# Build Fleet column now (ensures options reflect the data)
data["Fleet"] = data["EQPT"].apply(map_to_fleet)
# Build fleet options from whitelist intersecting present Fleet values
